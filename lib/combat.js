        ...
        if (keyIn === 'q') {
            ...
            if (targets.length > 0) {
                ...
                if (index != -1) {//If we didn't cancel
                    ...
                    if (type.savingThrows.length > 1) console.log("Saving Throws: " + type.savingThrows);
                    if (type.skills.length > 1) console.log("Skills: " + type.skills);
                    if (type.damageResistances.length > 1) console.log("Damage Resistances: " + type.damageResistances);
                    if (type.damageVulnerabilities.length > 1) console.log("Damage Vulnerabilities: " + type.damageVulnerabilities);
                    if (type.damageImmunities.length > 1) console.log("Damage Immunities: " + type.damageImmunities);
                    if (type.conditionImmunities.length > 1) console.log("Condition Immunities: " + type.conditionImmunities);
