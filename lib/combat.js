...
start [FILE]    starts combat using the provided file as startpoint.
create          creates a combat file using an interactive questionnaire.
...
function renderInitiativeOrder() {
    ...
    let actionHeader = "| Actions for " + currentActor.name + " |";
    ...
    initiativeOrder.forEach(function (actor) {
        ...
        console.log(renderActor(actor, nameLength, activeActor) + "\t\t" + printAction);
