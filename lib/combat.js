    ...
    while (running) {
        ...
        if (keyIn === 'q') {
            ...
            if(index != -1){//If we didn't cancel
                ...
                console.log(table(abScores, ["key", "value"], false, true));
...
function prettyDesc(string){
    ...
    string = string.replace("Ranged or Melee Weapon Attack:", chalk.blue("MWA/RWA"));
    string = string.replace("Melee or Ranged Weapon Attack:", chalk.blue("MWA/RWA"));
    string = string.replace("Melee Weapon Attack:", chalk.blue("MWA"));
    string = string.replace("Ranged Weapon Attack:", chalk.blue("RWA"));
