 ...
 */
exports.fromString = exports.decode = exports.roll = function(string){
    //Input validation
    if(!string || string.length < 2) return undefined;
    //Clean the string, remove anything that is not a d, x, a plus or a number
    string = string.trim().toLowerCase().replace(/^[xd0-9\+]/g, '');
    ...
    return (roll(size, amount)) * multiplier + modifier
}
