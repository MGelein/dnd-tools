 ...
 */
function getOrigin() {
    return chalk.bold("[Origin]: ") + rnd(geography) + "\n";
}
...
function getResource() {
    return chalk.bold("[Resource]: ") + rnd(resources) + "\n";
}
 ...
 */
function getCulture() {
    return chalk.bold("[Culture]: ") + rnd(culture) + "\n";
}
 ...
 */
function getRulers() {
    return chalk.bold("[Rulers]: ") + rnd(government) + "\n";
}
 ...
 */
function getHistory() {
    return chalk.bold("[History]: ") + rnd(history) + "\n";
}
 ...
 */
function getThreats() {
    return chalk.bold("[Threats]: ") + rnd(threats) + "\n";
}
 ...
 */
function getDefense() {
    return chalk.bold("[Defense]: ") + rnd(defense) + "\n";
}
 ...
 */
function getLaws() {
    return chalk.bold("[Laws]: ") + rnd(law) + "\n";
}
 ...
 */
function getPower() {
    return chalk.bold("[Power]: ") + rnd(power) + "\n";
}
