...
/**d100 lines, from https://www.reddit.com/r/DnD/comments/57xoau/lets_make_a_d100_table_for_events_that_occur/*/
const lines = ["Restless night. Do not gain any benefits from the long rest. roll to determine a party member which this happens to.",
...
"Slept on a small rock, root or stick. Have a tender spot or sore back for " + chalk.magenta.bold("1d4") + " hours.",
...
"A group of " + chalk.magenta.bold("1d4") + " wild boar attempt to eat all your food items. Player on watch can potentially lure them away.",
...
"a PC won't stop snoring. other players roll CON or are woken up and cannot get back to sleep due to the snoring. Disadvantage on ability checks for " + chalk.magenta.bold("1d4") + " hours in the morning.",
...
"a small mammal absconds with " + chalk.magenta.bold("1d4") + " coins, or a mundane small object in the PCs possession.",
...
"A dense fog rolls in and persists through the early morning (disadvantage on perception for " + chalk.magenta.bold("1d4") + " hours).",
...
"You find a pseragon rummaging around the groups treasury, if questioned he'll claim to be a real dragon cursed with being very, very small.",
...
"A player accidentally slept on top of their arm. That player h to dex rolls for " + chalk.magenta.bold("1d4") + " hours in the morning.",
"A snake is found coiled near the camp. If approached it slithers quickly away leaving a nest of " + chalk.magenta.bold("2d4+2") + " red eggs. They act as a healing potion if added to food.",
...
"some mischievous fay/sprite has managed to somehow extend your slumber. You oleep by " + chalk.magenta.bold("2d4") + " hours.",
...
"As your party awakens (party member with highest passive perception) sees a glimmer beneath a tree. Upon further inspection he/she finds a skeletal hand clutching " + chalk.magenta.bold("1d4") + " electrum coins + " + chalk.magenta.bold("5d10") + " silver pieces.",
"While packing up, a bird (or bat) does his business on (Random pc) in plain sight of everyone.",
"A random pc accidentally slept on a poisonous plant (appropriate to the environment) and now has a rash for " + chalk.magenta.bold("1d4") + " hours.",
"The night was excessively cold. As a result of the frost, it will take 1 complete action to unsheath weapons using scabbards for " + chalk.magenta.bold("1d8") + " hours.",
...
"your PCs share tales of their homelands or valiant deeds (perhaps embellishing to a degreperhaps someone reveals a major background poiinspiration for whichever PC did the best (subjective) job roleplaying.",
"Lightning strikes a nearby graveyard (" + chalk.magenta.bold("1d8") + " zombies begin to wander within it).",
...
"A group of " + chalk.magenta.bold("1d4") + " bandits raid the camp at night, all PCs wake up and must defend themselves. However, right before combat begins a horn is blown and the bandits retreat. I wonder why?",
...
"A random PC catches a cold, disadvantage on ability checks for " + chalk.magenta.bold("4d6") + " hours.",
...
"An NPC explains you're not allowed to camp here, and demands " + chalk.magenta.bold("2d4") + " silver from the party.",
