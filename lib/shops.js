...
function generateGeneral(size) {
    ...
    size = parseSize(size);
    //Next go through the list of items and add to inventory where appropriate
    if (size >= 1) inventory.push({ name: "Abacus", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Barrel", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Blanket", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Bottle, glass", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Bucket", price: "5cp" });
    if (size >= 0) inventory.push({ name: "Candle", price: "1cp" });
    if (size >= 1) inventory.push({ name: "Chest", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Clothes, Common", price: "5sp" });
    if (size >= 2) inventory.push({ name: "Clothes, Fine", price: "15gp" });
    if (size >= 0) inventory.push({ name: "Flask or Tankard", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Hammer", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Ink (1 ounce bottle)", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Ink Pen", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Jug or Pitcher", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Ladder (10-foot)", price: "1sp" });
    if (size >= 1) inventory.push({ name: "Lantern, Hooded", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Lock", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Mess Kit", price: "2sp" });
    if (size >= 0) inventory.push({ name: "Mirror, Steel", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Paper (one sheet)", price: "2sp" });
    if (size >= 0) inventory.push({ name: "Parchment (one sheet)", price: "1sp" });
    if (size >= 0) inventory.push({ name: "Pick, Miner's", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Pot, Iron", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Pouch", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Rope, Hempen (50 feet)", price: "1gp" });
    if (size >= 2) inventory.push({ name: "Rope, Silk (50 feet)", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Sack", price: "1cp" });
    if (size >= 1) inventory.push({ name: "Scale, Merchant's", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Shovel", price: "2gp" });
    if (size >= 1) inventory.push({ name: "Signet Ring", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Soap", price: "2cp" });
    if (size >= 1) inventory.push({ name: "Vial", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Carpenter's Tools", price: "15gp" });
    if (size >= 0) inventory.push({ name: "Cobbler's Tools", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Cook's Utensils", price: "50gp" });
    if (size >= 2) inventory.push({ name: "Glassblower's Tools", price: "30gp" });
    if (size >= 1) inventory.push({ name: "Leatherworker's Tools", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Mason's Tools", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Potter's Tools", price: "10gp" });
    if (size >= 2) inventory.push({ name: "Smith's Tools", price: "20gp" });
    if (size >= 0) inventory.push({ name: "Weaver's Tools", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Woodcarver's Tools", price: "1gp" });
...
function generateAdventuring(size) {
    ...
    size = parseSize(size);
    //Next go through the list of items and add to inventory where appropriate
    if (size >= 1) inventory.push({ name: "Padded", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Leather", price: "10gp" });
    if (size >= 2) inventory.push({ name: "Studded Leather", price: "45gp" });
    if (size >= 0) inventory.push({ name: "Hide", price: "10gp" });
    if (size >= 2) inventory.push({ name: "Club", price: "1sp" });
    if (size >= 0) inventory.push({ name: "Dagger", price: "2gp" });
    if (size >= 1) inventory.push({ name: "Greatclub", price: "2sp" });
    if (size >= 0) inventory.push({ name: "Handaxe", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Light Hammer", price: "2gp" });
    if (size >= 1) inventory.push({ name: "Quarterstaff", price: "2sp" });
    if (size >= 1) inventory.push({ name: "Crossbow, Light", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Dart", price: "5cp" });
    if (size >= 0) inventory.push({ name: "Shortbow", price: "25gp" });
    if (size >= 1) inventory.push({ name: "Sling", price: "1sp" });
    if (size >= 0) inventory.push({ name: "Whip", price: "2gp" });
    if (size >= 2) inventory.push({ name: "Blowgun", price: "10gp" });
    if (size >= 1) inventory.push({ name: "Crossbow, hand", price: "75gp" });
    if (size >= 2) inventory.push({ name: "Crossbow, heavy", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Longbow", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Arrows (20)", price: "1gp" });
    if (size >= 2) inventory.push({ name: "Blowgun Needles (50)", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Crossbow Bolts (20)", price: "1gp" });
    if (size >= 1) inventory.push({ name: "Sling Bullets (20)", price: "4cp" });
    if (size >= 0) inventory.push({ name: "Backpack", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Bedroll", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Blanket", price: "5sp" });
    if (size >= 1) inventory.push({ name: "Block and Tackle", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Bottle, glass", price: "2gp" });
    if (size >= 1) inventory.push({ name: "Candle", price: "1cp" });
    if (size >= 1) inventory.push({ name: "Case, Crossbow Bolt", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Case, Map or Scroll", price: "1gp" });
    if (size >= 1) inventory.push({ name: "Chain (10 feet)", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Chest", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Climber's Kit", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Clothes, Traveler's", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Crowbar", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Flask or Tankard", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Grappling Hook", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Hammer", price: "1gp" });
    if (size >= 2) inventory.push({ name: "Healer's Kit", price: "5gp" });
    if (size >= 2) inventory.push({ name: "Hourglass", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Hunting Trap", price: "5gp" });
    if (size >= 2) inventory.push({ name: "Ink (1 ounce bottle)", price: "10gp" });
    if (size >= 1) inventory.push({ name: "Ink Pen", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Jug or Pitcher", price: "2cp" });
    if (size >= 1) inventory.push({ name: "Ladder (10-foot)", price: "1sp" });
    if (size >= 1) inventory.push({ name: "Lantern, Bullseye", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Lantern, Hooded", price: "5gp" });
    if (size >= 2) inventory.push({ name: "Lock", price: "10gp" });
    if (size >= 1) inventory.push({ name: "Mess Kit", price: "2sp" });
    if (size >= 1) inventory.push({ name: "Mirror, Steel", price: "5gp" });
    if (size >= 2) inventory.push({ name: "Paper (one sheet)", price: "2sp" });
    if (size >= 1) inventory.push({ name: "Parchment (one sheet)", price: "1sp" });
    if (size >= 0) inventory.push({ name: "Pick, Miner's", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Piton", price: "5cp" });
    if (size >= 0) inventory.push({ name: "Pole (10-foot)", price: "5cp" });
    if (size >= 0) inventory.push({ name: "Pot, Iron", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Pouch", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Quiver", price: "1gp" });
    if (size >= 1) inventory.push({ name: "Rations (1 day)", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Rope, Hempen (50 feet)", price: "1gp" });
    if (size >= 2) inventory.push({ name: "Rope, Silk (50 feet)", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Sack", price: "1cp" });
    if (size >= 0) inventory.push({ name: "Shovel", price: "2gp" });
    if (size >= 1) inventory.push({ name: "Signal Whistle", price: "5cp" });
    if (size >= 2) inventory.push({ name: "Signet Ring", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Spyglass", price: "1000gp" });
    if (size >= 0) inventory.push({ name: "Tent, Two-person", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Tinderbox", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Torch", price: "1cp" });
    if (size >= 0) inventory.push({ name: "Vial", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Waterskin", price: "2sp" });
    if (size >= 1) inventory.push({ name: "Cartographer's Tools", price: "15gp" });
    if (size >= 2) inventory.push({ name: "Jeweler's Tools", price: "25gp" });
    if (size >= 1) inventory.push({ name: "Tinker's Tools", price: "50gp" });
    if (size >= 1) inventory.push({ name: "Herbalism Kit", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Navigator's Tools", price: "25gp" });
...
function generateJeweler(size) {
    ...
    size = parseSize(size);
    //Next go through the list of items and add to inventory where appropriate
    if (size >= 0) inventory.push({ name: "Amulet/Necklace, Exquisite", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Amulet/Necklace, Mundane", price: "5sp" });
    if (size >= 1) inventory.push({ name: "Crystal", price: "10gp" });
    if (size >= 2) inventory.push({ name: "Orb", price: "20gp" });
    if (size >= 0) inventory.push({ name: "Earrings, Exquisite", price: "4gp" });
    if (size >= 0) inventory.push({ name: "Earrings, Mundane", price: "4sp" });
    if (size >= 0) inventory.push({ name: "Ring, Exquisite", price: "3gp" });
    if (size >= 0) inventory.push({ name: "Ring, Mundane", price: "3sp" });
    if (size >= 0) inventory.push({ name: "Signet Ring", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Jeweler's Tools", price: "25gp" });
    if (size >= 0) services.push({ name: "Gemstone Appraisal (3 gems)", price: "5gp" });
    if (size >= 0) services.push({ name: "Resizing Jewelry", price: "10gp" });
    if (size >= 0) services.push({ name: "Set Gem (<100 gp value)", price: "45gp" });
    if (size >= 0) services.push({ name: "Set Gem (100-1K gp value)", price: "75gp" });
    if (size >= 0) services.push({ name: "Set Gem (1K+ gp value)", price: "150gp" });
...
function generateTailor(size) {
    ...
    //Next go through the list of items and add to inventory where appropriate
    if (size >= 0) inventory.push({ name: "Backpack", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Basket", price: "4sp" });
    if (size >= 0) inventory.push({ name: "Bedroll", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Blanket", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Clothes, Common", price: "5sp" });
    if (size >= 2) inventory.push({ name: "Clothes, Costume", price: "5gp" });
    if (size >= 1) inventory.push({ name: "Clothes, Fine", price: "15gp" });
    if (size >= 0) inventory.push({ name: "Clothes, Traveler's", price: "2gp" });
    if (size >= 2) inventory.push({ name: "Component Pouch", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Pouch", price: "5sp" });
    if (size >= 0) inventory.push({ name: "Robes", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Sack", price: "1cp" });
    if (size >= 1) inventory.push({ name: "Tent, Two-person", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Weaver's Tools", price: "1gp" });
...
function generatePotion(size) {
    ...
    size = parseSize(size);
    //Next go through the list of items and add to inventory where appropriate
    if (size >= 0) inventory.push({ name: "Acid (vial)", price: "25gp" });
    if (size >= 1) inventory.push({ name: "Alchemist's Fire (flask)", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Antitoxin (vial)", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Bottle, glass", price: "2gp" });
    if (size >= 0) inventory.push({ name: "Component Pouch", price: "25gp" });
    if (size >= 0) inventory.push({ name: "Flask", price: "2cp" });
    if (size >= 1) inventory.push({ name: "Healer's Kit", price: "5gp" });
    if (size >= 2) inventory.push({ name: "Ink (1 ounce bottle)", price: "10gp" });
    if (size >= 0) inventory.push({ name: "Jug", price: "2cp" });
    if (size >= 0) inventory.push({ name: "Oil (flask)", price: "1sp" });
    if (size >= 2) inventory.push({ name: "Perfume (vial)", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Poison, Basic (vial)", price: "100gp" });
    if (size >= 0) inventory.push({ name: "Potion of Healing", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Vial", price: "1gp" });
    if (size >= 1) inventory.push({ name: "Alchemist's Supplies", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Brewer's Supplies", price: "20gp" });
    if (size >= 1) inventory.push({ name: "Cook's Utensils", price: "1gp" });
    if (size >= 0) inventory.push({ name: "Herbalism Kit", price: "5gp" });
    if (size >= 0) inventory.push({ name: "Poisoner's Kit", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Common potion", price: "50gp" });
    if (size >= 0) inventory.push({ name: "Uncommon potion", price: "250gp" });
    if (size >= 1) inventory.push({ name: "Rare potion", price: "2500gp" });
...
function generateArcane(size) {
    ...
    size = parseSize(size);
    //Next go through the list of items and add to inventory where appropriate
    if(size >= 0) inventory.push({name: "Quarterstaff", price:"2sp"});
    if(size >= 1) inventory.push({name: "Abacus", price:"2gp"});
    if(size >= 0) inventory.push({name: "Crystal", price:"10gp"});
    if(size >= 1) inventory.push({name: "Orb", price:"20gp"});
    if(size >= 0) inventory.push({name: "Rod", price:"10gp"});
    if(size >= 0) inventory.push({name: "Staff", price:"5gp"});
    if(size >= 0) inventory.push({name: "Wand", price:"10gp"});
    if(size >= 0) inventory.push({name: "Bottle, glass", price:"2gp"});
    if(size >= 0) inventory.push({name: "Candle", price:"1cp"});
    if(size >= 0) inventory.push({name: "Case, Map or Scroll", price:"1gp"});
    if(size >= 0) inventory.push({name: "Component Pouch", price:"25gp"});
    if(size >= 0) inventory.push({name: "Sprig of Mistletoe", price:"1gp"});
    if(size >= 1) inventory.push({name: "Totem", price:"1gp"});
    if(size >= 0) inventory.push({name: "Wooden Staff", price:"5gp"});
    if(size >= 0) inventory.push({name: "Yew Wand", price:"10gp"});
    if(size >= 2) inventory.push({name: "Hourglass", price:"25gp"});
    if(size >= 0) inventory.push({name: "Ink (1 ounce bottle)", price:"10gp"});
    if(size >= 0) inventory.push({name: "Ink Pen", price:"2cp"});
    if(size >= 1) inventory.push({name: "Paper (one sheet)", price:"2sp"});
    if(size >= 0) inventory.push({name: "Parchment (one sheet)", price:"1sp"});
    if(size >= 0) inventory.push({name: "Pouch", price:"5sp"});
    if(size >= 1) inventory.push({name: "Robes", price:"1gp"});
    if(size >= 0) inventory.push({name: "Spellbook", price:"50gp"});
    if(size >= 0) inventory.push({name: "Vial", price:"1gp"});
    if(size >= 0) inventory.push({name: "Alchemist's Supplies", price:"50gp"});
    if(size >= 1) inventory.push({name: "Calligrapher's Supplies", price:"10gp"});
    if(size >= 1) inventory.push({name: "Lute", price:"35gp"});
    if(size >= 2) inventory.push({name: "Lyre", price:"30gp"});
    if(size >= 0) inventory.push({name: "Common Scroll (Cantrip)", price:"50gp"});
    if(size >= 0) inventory.push({name: "Common Scroll (Level 1)", price:"100gp"});
    if(size >= 1) inventory.push({name: "Uncommon Scroll (Level 2)", price:"250gp"});
    if(size >= 1) inventory.push({name: "Uncommon Scroll (Level 3)", price:"500gp"});
    if(size >= 2) inventory.push({name: "Rare Scroll (Level 4)", price:"2500gp"});
    if(size >= 2) inventory.push({name: "Rare Scroll (Level 5)", price:"5000gp"});
